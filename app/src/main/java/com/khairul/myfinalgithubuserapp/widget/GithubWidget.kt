...
class GithubWidget : AppWidgetProvider() {
    companion object {
        private const val TOAST_ACTION = "com.khairul.myfinalgithubuserapp.TOAST_ACTION"
        ...
        private fun updateAppWidget(
            ...
            val remoteViews = RemoteViews(context.packageName, R.layout.widget_fragment)
            ...
            appWidgetManager.apply {
                notifyAppWidgetViewDataChanged(appWidgetId, R.layout.widget_fragment)
