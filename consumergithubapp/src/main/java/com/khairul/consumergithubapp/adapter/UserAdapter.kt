...
import com.khairul.consumergithubapp.databinding.ItemUserListBinding
import com.khairul.consumergithubapp.model.GithubUser

class UserAdapter(
    private val githubUsers: ArrayList<GithubUser>,
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) =
        holder.bind(githubUsers[position], clickListener)
